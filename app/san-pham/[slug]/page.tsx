...
import { categories, orderStatusLabels, mynoraOperationalCopy, mynoraSiteSettings } from "../../lib/site-data";
...
export default async function Product({ params }: ProductPageProps) {
  ...
  const catalogProducts = await getPublicCatalog(); const product = catalogProducts.find(p => p.slug === slug);
  if (!product) notFound();
