...
export async function StoreShell({ children, tone = "commerce" }: { children: React.ReactNode; tone?: "editorial" | "commerce" | "transaction" }) {
...
export async function Page({ eyebrow, title, intro, children, tone = "commerce" }: { eyebrow?: string; title: string; intro?: string; children?: React.ReactNode; tone?: "editorial" | "commerce" | "transaction" }) {
...
export function ProductGrid({ items }: { items: readonly CatalogProduct[] }) {
